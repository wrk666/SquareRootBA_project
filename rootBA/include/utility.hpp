...
namespace rootBA {
    //定义类型模板，using Vector3 = Eigen::Matrix<Scalar, 3, 1>;  Matrix15实际上等于 template<typename Scalar> Eigen::Matrix<Scalar, 15, 15>;
    //这样更好理解
    template<typename Scalar>
    using Matrix15 = Eigen::Matrix<Scalar, 15, 15>;
    ...
    template<typename Scalar> using Matrix9 = Eigen::Matrix<Scalar, 9, 9>;
